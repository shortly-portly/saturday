...
describe SignUpAdmin do
  it "should create an Admin AND User" do
    params = {"first_name" => "Dave", "last_name" => "Simmons", "email" => "dave@email.com", "password" => "davedave", "password_confirmation" => "davedave"}
  ...
  it "should return errors if mandatory admin fields are not specified" do
    params = {"email" => "dave@email.com", "password" => "davedave", "password_confirmation" => "davedave"}
